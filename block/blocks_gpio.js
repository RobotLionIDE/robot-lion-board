...
Blockly.Blocks['io_digital_read'] = {
  init: function() {
    this.appendValueInput("pin")
        .setCheck("Number")
        .appendField("Считать цифровое значение с пина");
    this.setInputsInline(true);
...
Blockly.Blocks['io_digital_write'] = {
  init: function() {
    this.appendValueInput("pin")
        .setCheck("Number")
        .appendField("Записать цифровое значение в пин");
...
Blockly.Blocks['io_analog_read'] = {
  init: function() {
    this.appendValueInput("pin")
        .setCheck("Number")
        .appendField("Считать аналоговое значение с пина ");
    this.setInputsInline(true);
    this.setOutput(true, "Number");
    this.setColour(45);
...
Blockly.Blocks['io_analog_write'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Записать аналоговое значение в пин")
...
Blockly.Blocks['io_pwm_write'] = {
  init: function() {
    this.appendValueInput("pin")
        .setCheck("Number")
        .appendField("Записать ШИМ в пин");
    this.appendValueInput("value")
        .setCheck("Number")
