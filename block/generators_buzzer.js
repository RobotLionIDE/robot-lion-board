...
module.exports = function(Blockly) {
  ...
  Blockly.JavaScript['RL_note'] = function(block) {
    var code = 'tone('+ block.getFieldValue('NOTE') + ',' + block.getFieldValue('DURATION') + ');\n';
    return code;
  };

  Blockly.JavaScript["RL_notes"] = function(block) {
  ...
  Blockly.JavaScript["RL_buzzer_note"] = function(block) {
    var value_tone = block.getFieldValue("NOTE");
    var value_dulation = block.getFieldValue("DURATION");
    var code = `tone(${value_tone}, ${value_dulation});`;
    return code;
  };
  
  Blockly.JavaScript["RL_play_notes"] = function(block) {
    ...
    let code = `song(${value_note},${number_duration});\n`;
    return code;
  };
  
  Blockly.JavaScript["RL_song_mario_underworld"] = function (block) {
    let text_notes = block.getFieldValue("notes").split(",").map(e => e.trim());
    let keyNote = text_notes.map(e => (e in notes) ? notes[e] : -1);
    let code = `(std::vector<int>{${keyNote}})`;
    return [code, Blockly.JavaScript.ORDER_NONE];
  ...
  Blockly.JavaScript["RL_song_jingle_bell"] = function (block) {
    let text_notes = block.getFieldValue("notes").split(",").map(e => e.trim());
    let keyNote = text_notes.map(e => (e in notes) ? notes[e] : -1);
    let code = `(std::vector<int>{${keyNote}})`;
    return [code, Blockly.JavaScript.ORDER_NONE];
  ...
  Blockly.JavaScript["RL_song_cannon_rock"] = function (block) {
    let text_notes = block.getFieldValue("notes").split(",").map(e => e.trim());
    let keyNote = text_notes.map(e => (e in notes) ? notes[e] : -1);
    let code = `(std::vector<int>{${keyNote}})`;
    return [code, Blockly.JavaScript.ORDER_NONE];
  ...
  Blockly.JavaScript['RL_beep'] = function(block) {
    var code = 'beep();\n';
    return code;
  };
  Blockly.JavaScript['RL_beep_on'] = function(block) {
    var code = 'beep_on();\n';
    return code;
  };
  Blockly.JavaScript['RL_beep_off'] = function(block) {
    var code = 'beep_off();\n';
    return code;
  };
  Blockly.JavaScript['RL_beep_delay'] = function(block) {
